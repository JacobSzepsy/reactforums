...
class Login extends Component{
	...
	submitHandler = (e) => {
		...
		//todo: have this redirect back to previous page but make sure you are not going back to register page
			...
			<div className="card my-4" style={style}>
				<div className="card-body">
					<form onSubmit={this.submitHandler}>
						...
						<br/><br/>
						<Link className='linkBlack' to="/register">Don't have an account?</Link>
						<br/><br/>
